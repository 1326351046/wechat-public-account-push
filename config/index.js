export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxbd1dad417ad4eac2",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "52c465bd3ce310d739c1eb3df0b05af1",
  ...
  USERS: [
    {
      ...
      id: "ogG8j50K_Ry7JbFBOgfZvQQirqrk,ogG8j533lMpApBgeSDzqmoTl7JOc",
      // 你想对他发送的模板消息的模板ID
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "小白", "year": "1998", "date": "10-09"},
    ...
    {
      name: "老婆1",
      id: "ogG8j50KRy7JbFBOgfZvQQirqrk,ogG8j533lMpApBgeSDzqmoTl7JOc",
      useTemplateId: "yiqBUsVktQ1uxxiT2wtnuor0TmRDKyWuQWxY1Vz0BQc",
      province: "河南",
      city: "洛阳",
      horoscopeDate: '',
